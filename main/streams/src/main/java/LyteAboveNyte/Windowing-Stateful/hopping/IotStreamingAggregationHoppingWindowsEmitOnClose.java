...
import bbejeck.Processor-API.aggregator.IotStreamingAggregator;
import bbejeck.Processor-API.data.IotWindowedRecordSupplier;
...
public class IotStreamingAggregationHoppingWindowsEmitOnClose extends BaseStreamsApplication {

     private static final Logger LOG = LoggerFactory.getLogger(IotStreamingAggregationHoppingWindowsEmitOnClose.class);
     static String inputTopic = "heat-sensor-hopping-emit-close-input";
     static String outputTopic = "sensor-agg-output-hopping-emit-close";
    ...
    public static void main(String[] args) throws Exception {
        ...
        IotStreamingAggregationHoppingWindowsEmitOnClose iotStreamingAggregationHoppingWindows = new IotStreamingAggregationHoppingWindowsEmitOnClose();
        Properties properties = new Properties();
        properties.put(BOOTSTRAP_SERVERS_CONFIG, "localhost:9092");
        properties.put(APPLICATION_ID_CONFIG, "iot-streaming-aggregation-hopping-windows-emit-on-close");
