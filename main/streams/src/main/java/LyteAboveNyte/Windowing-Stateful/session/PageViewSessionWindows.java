package bbejeck.Processor-API.session;

import bbejeck.BaseStreamsApplication;
import bbejeck.Processor-API.aggregator.PageViewAggregator;
import bbejeck.Processor-API.data.PageViewSessionsRecordSupplier;
...
public class PageViewSessionWindows extends BaseStreamsApplication {
      ...
      static final String INPUT_TOPIC = "page-view-session-windows-input";
      static final String OUTPUT_TOPIC = "page-view-session-aggregates";
    @Override
