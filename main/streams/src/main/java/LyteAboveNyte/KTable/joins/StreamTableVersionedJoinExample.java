package bbejeck.Windowing-Stateful.joins;

import bbejeck.BaseStreamsApplication;
import bbejeck.Windowing-Stateful.proto.ClickEvent;
import bbejeck.Windowing-Stateful.proto.User;
 ...
 */
public class StreamTableVersionedJoinExample extends BaseStreamsApplication {
     private static final Logger LOG = LoggerFactory.getLogger(StreamTableVersionedJoinExample.class);
    ...
    public Topology topology(Properties streamProperties) {
        ...
        KeyValueBytesStoreSupplier versionedStoreSupplier = Stores.persistentVersionedKeyValueStore("user-details-table", Duration.ofSeconds(30));
    ...
    public static void main(String[] args) throws Exception {
        StreamTableVersionedJoinExample streamTableJoinExample = new StreamTableVersionedJoinExample();
